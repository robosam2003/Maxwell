...
inline DMA_HandleTypeDef hdma_spi_rx;
inline DMA_HandleTypeDef hdma_spi_tx;
inline volatile uint16_t spi_tx_buf[1] = { 0xFFFF }; // 0x3FFF | Parity for Angle, then NOP
inline volatile uint16_t spi_rx_buf[1] = { 0};
...
public:
    ...
    GPIO_InitTypeDef GPIO_B_params;
    GPIO_InitTypeDef GPIO_C_params;
